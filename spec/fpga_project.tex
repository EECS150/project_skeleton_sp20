...
The following is a brief description of each checkpoint and approximately how many weeks will be alloted to each one. Note that this schedule is tentative and is subjected to change as the semester progresses. The checkpoints are mostly for you to work progressively towards to goal of building a fully-functional RISC-V core. Do not expect to start working on the project last minute.
...
it is highly suggested that you do git pull to get the latest update.
...
\begin{center}
  \begin{tabular}{m{30mm} m{35mm} m{70mm}}
    ...
    \midrule
    Revised Block Diagram, Working ALU, Instructional Decoder, Basic datapath and control & \ALUDueDate & Check in your code to Github. Go over your RISC-V microarchitecture with TA\\
    \midrule
