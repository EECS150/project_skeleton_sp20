...
\begin{center}
  ...
  \caption{A waveform of memory write with a burst length of 8. Note that \textbf{req\_write\_data\_valid} and \textbf{req\_write\_data\_ready} must be high for one write trasaction beat.}
